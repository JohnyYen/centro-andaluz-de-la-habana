...
export interface ApiDishDish extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<['CUP', 'EUR']> &
      Schema.Attribute.DefaultTo<'CUP'>;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    dish_name: Schema.Attribute.UID<'name'>;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Centro Andaluz de la Habana en Prado 356-358, entre Neptuno y Virtudes'>;
    artists: Schema.Attribute.Component<'shared.artist', true>;
    ...
    price: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'event_name'>;
